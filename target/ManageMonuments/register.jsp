  ...
  <div class="one">
    <div class="register">
	  ...
	  <div>
          ...
          <input type="text" id="username" maxlength ="12" spellcheck="false" placeholder="<%=request.getParameter("aadharNo")%>"  name="aadharNo"/>
        </div>
		<div>
        ...
        <div>
          ...
          <input type="text" id="name" spellcheck="false" placeholder="FirstName" name="fname"/>
        </div>
		<div>
          <label for="name">LastName*</label>
          <input type="text" id="name" spellcheck="false" placeholder="LastName" name="lname"/>
        </div>
        <div>
